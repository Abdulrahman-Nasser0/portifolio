            ...
            <PhotoReveal delay={1.2} duration={1}>
              <div className="flex justify-center lg:justify-end">
                <div className="relative">
                  {/* Main container */}
                  <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 shadow-2xl p-8 flex flex-col justify-center items-center">
